...
"""
O formato é um padrão de compactar arquivamento
...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'aula_280_diretorio_zip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'aula280_compactado.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'aula280_descompactado'
